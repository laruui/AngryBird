...
public class GameModel implements ActionListener {
	...
	//e就是从这里给的，找他的数据都是从哪里来
	public GameModel() {
		//各种实体，e应该是从这里获得的，或者说这里就是个类的初始化，找赋值语句
	...
	public void addEgg() {
		...
		if (eggLeft > 0) {
    		...
    		System.out.println("没有剩余鸡蛋");
	}
	
	public void updateEntity() {
		ArrayList<Entity> toRemove = new ArrayList<Entity>(); //它仅仅只能重新圈外后从列表中删除实体
		int birdTest = 0;									
		int pigTest = 0;
		int eggTest = 0;
